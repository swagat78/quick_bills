...
parcelHelpers.export(exports, "CLSThresholds", ()=>E);
parcelHelpers.export(exports, "FCPThresholds", ()=>y);
parcelHelpers.export(exports, "INPThresholds", ()=>B);
parcelHelpers.export(exports, "LCPThresholds", ()=>N);
parcelHelpers.export(exports, "TTFBThresholds", ()=>H);
parcelHelpers.export(exports, "onCLS", ()=>b);
parcelHelpers.export(exports, "onFCP", ()=>T);
parcelHelpers.export(exports, "onINP", ()=>S);
parcelHelpers.export(exports, "onLCP", ()=>x);
parcelHelpers.export(exports, "onTTFB", ()=>$);
let e = -1;
const t = (t)=>{
...
let l = -1;
const u = new Set, m = ()=>"hidden" !== document.visibilityState || document.prerendering ? 1 / 0 : 0, g = (e)=>{
    ...
    if (l < 0) {
        const e = o(), n = document.prerendering ? void 0 : globalThis.performance.getEntriesByType("visibility-state").find((t)=>"hidden" === t.name && t.startTime >= e)?.startTime;
        l = n ?? m(), addEventListener("visibilitychange", g, !0), addEventListener("prerenderingchange", g, !0), t(()=>{
            setTimeout(()=>{
                l = m();
            });
        });
...
class k {
    ...
    h(e) {
        ...
        if (n || this.l.length < 10 || e.duration > t.L) {
            if (n ? e.duration > n.L ? (n.entries = [
                e
            ], n.L = e.duration) : e.duration === n.L && e.startTime === n.entries[0].startTime && n.entries.push(e) : (n = {
                id: e.interactionId,
                entries: [
                    e
                ],
...
const N = [
    ...
    v(()=>{
        ...
        const u = a(s, q), m = (e)=>{
            ...
            for (const t of e)u.h(t), t.startTime < c.firstHiddenTime && (l.value = Math.max(t.startTime - o(), 0), l.entries = [
                t
            ], d());
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["8z05v"], null, "parcelRequire7c69", {})
